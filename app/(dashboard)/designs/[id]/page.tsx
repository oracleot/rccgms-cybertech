...
export default async function DesignDetailPage({ params }: DesignDetailPageProps) {
  ...
  const isAdminOrLeader = profile?.role === "admin" || profile?.role === "developer" || profile?.role === "leader"
  const currentUserRole = (profile?.role as "admin" | "developer" | "leader" | "member") || "member"
